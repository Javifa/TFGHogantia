...
class DatosDemo {
    ...
    Compra(
      ...
      lineas: [
        ...
        const LineaCompra(
          id: 'l-8',
          compraId: 'c-2',
          nombreItem: 'Embutidos',
          cantidad: 1,
          precioUnitario: 18.61,
          subtotal: 18.61,
        ),
      ],
    ),
  ...
  static ResumenGastos get resumenMesActual {
    ...
    return ResumenGastos(
      ...
      totalMes: 253.55,
      numCompras: 5,
      gastosPorTienda: {'Mercadona': 103.05, 'Lidl': 61.00, 'Carrefour': 89.50},
    );
  }
