...
class _EstanciaFormState extends State<EstanciaForm> {
  ...
  Future<void> _guardar() async {
    ...
    bool ok;
    if (_esEdicion) {
      ok = await facade.actualizarEstancia(
        widget.estancia!.copyWith(
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _esEdicion ? 'Editar estancia' : 'Nueva estancia',
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: _guardar,
                child: Text(_esEdicion ? 'Guardar' : 'Crear estancia'),
              ),
            ),
          ],
        ),
