            ...
            onPressed: () async {
              ...
              if (ok && mounted) {
                ...
                ScaffoldMessenger.of(context)
                  ...
                  ..showSnackBar(
                    SnackBar(
                      content: Text(facade.error ?? 'Error al eliminar'),
                    ),
                  );
              }
            },
                      ...
                      ...c.lineas.map(
                        (l) => Card(
                          child: ListTile(
                            ...
                            subtitle: Text(
                              '${l.cantidad} x ${Formatters.moneda(l.precioUnitario)}',
                            ),
                            trailing: Text(
                              Formatters.moneda(l.subtotal),
                              style: const TextStyle(
                                fontWeight: FontWeight.w600,
                              ),
                            ),
