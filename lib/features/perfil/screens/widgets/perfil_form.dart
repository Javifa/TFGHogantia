...
class _PerfilFormState extends State<PerfilForm> {
  ...
  Future<void> _seleccionarAvatar() async {
    ...
    final imagen = await picker.pickImage(source: ImageSource.gallery, maxWidth: 500, imageQuality: 80);
  ...
  Future<void> _borrarCuenta() async {
    final ok = await ConfirmDialog.mostrar(
      ...
      mensaje: '¿Estás completamente seguro? Esta acción borrará todos tus datos y no se puede deshacer.',
  ...
  Widget build(BuildContext context) {
    final inicial = widget.usuario.nombreVisible.isNotEmpty ? widget.usuario.nombreVisible[0].toUpperCase() : 'U';
            ...
            children: [
                    ...
                    children: [
                      CircleAvatar(
                        ...
                        backgroundImage: _avatarBytes != null 
                            ...
                            : (widget.usuario.avatarUrl != null ? NetworkImage(widget.usuario.avatarUrl!) : null) as ImageProvider?,
                        child: (_avatarBytes == null && widget.usuario.avatarUrl == null)
                            ? Text(inicial, style: const TextStyle(fontSize: 40, fontWeight: FontWeight.bold, color: AppColors.primary))
                            : null,
                      ),
                      Positioned(
                        bottom: 0,
              ...
              SizedBox(
                ...
                child: OutlinedButton.icon(
                  ...
                  label: const Text('Eliminar cuenta permanentemente', style: TextStyle(color: AppColors.error)),
