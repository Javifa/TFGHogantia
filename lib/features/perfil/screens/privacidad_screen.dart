        ...
        child: Column(
          ...
          children: [
            ...
            _Seccion(
              ...
              texto: 'Todos los datos almacenados en nuestros servidores están cifrados mediante AES-256. Tus fotografías (tickets y avatares) se almacenan de forma segura.',
            ),
            const SizedBox(height: 24),
            _Seccion(
              icono: Icons.policy_outlined,
              titulo: 'Row Level Security (RLS)',
              texto: 'Utilizamos políticas a nivel de fila en la base de datos PostgreSQL, garantizando criptográficamente que es imposible que otros usuarios accedan a tus registros.',
            ),
            const SizedBox(height: 24),
            _Seccion(
              icono: Icons.delete_sweep_outlined,
              titulo: 'Derecho al olvido',
              texto: 'Al borrar tu cuenta, todos tus datos, compras y estancias se eliminan de forma permanente e irrecuperable de nuestros sistemas en un plazo máximo de 24 horas.',
            ),
            const SizedBox(height: 32),
          ],
        ),
      ...
      children: [
        ...
        Expanded(
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text(titulo, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppColors.textPrimary)),
              const SizedBox(height: 8),
              Text(texto, style: const TextStyle(fontSize: 14, color: AppColors.textSecondary, height: 1.4)),
            ],
          ),
        ),
      ],
